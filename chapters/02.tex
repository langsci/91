...
\citet{Roberts1975} reports the following contrast from Jamaican Creole (JC):
...
VP → \ldots~(VP) & (some speakers for \textit{teki} instrumentals; all speakers for \textit{go} directionals; some speakers for \textit{gi} dative/benefactives)\\
