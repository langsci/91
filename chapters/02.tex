...
postman {\sc pm} {\sc comp} bring letter here\\
...
he {\sc tns} {\sc mod} go evening for go burn house that boy-the  but on path {\sc pl} witch {\sc comp} attack him\\
...
\ea\label{ex:2:41}
\gll i ana Born Lulu i d{\^a}se deor\\
{\sc pm} there-is good-guy wolf {\sc pm} dance outside \\
