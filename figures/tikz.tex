...
\resizebox{\textwidth}{!}{
	...
	\draw (node cs:name=3NP) -- (node cs:name=4i);
	\draw (node cs:name=3V) -- (node cs:name=4waan);
	\draw (node cs:name=3S) -- (node cs:name=4comp);
	\draw (node cs:name=3S) -- (node cs:name=4S);
	\draw (node cs:name=4S) -- (node cs:name=5NP);
	\draw (node cs:name=4S) -- (node cs:name=5Aux);
	\draw (node cs:name=4S) -- (node cs:name=5V);
	\draw (node cs:name=4S) -- (node cs:name=5NP2);
	\draw (node cs:name=5NP) -- (node cs:name=6mi);
	\draw (node cs:name=5Aux) -- (node cs:name=6fi);
	\draw (node cs:name=5V) -- (node cs:name=6go);
	...
	\draw [dashed] (6WH.south) edge [bend left=60] (5fi.south);
	\draw [dashed] (5fi.south west) edge [bend left=50] (3space.south);
